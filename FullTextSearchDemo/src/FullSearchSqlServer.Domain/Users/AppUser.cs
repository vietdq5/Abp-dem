...
namespace FullSearchSqlServer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update FullSearchSqlServerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update FullSearchSqlServerEfCoreEntityExtensionMappings to extend the IdentityUser entity
