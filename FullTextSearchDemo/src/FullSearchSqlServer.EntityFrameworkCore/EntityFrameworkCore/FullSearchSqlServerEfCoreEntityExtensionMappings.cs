...
{
    public static class FullSearchSqlServerEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE FullSearchSqlServerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
